...
{% capture notice-text %}
**Doctoral Students**
1. **Truong Tuan Vu** ([VinUniversity](https://vinuni.edu.vn/), 03/2023--present, co-supervise with [Prof. Van-Dinh Nguyen](https://vinuni.edu.vn/people/nguyen-van-dinh-phd/). Topic: Resouce allocation for network slicing in open radio access network (O-RAN).

**Master's Students**
1. **Xavier Goeman and Carlos Guzman** ([Institut Polytechnique de Paris](https://www.ip-paris.fr/en), 11/2020--04/2021). Topic: Modeling and implementation of embedding algorithms for network slices dedicated to multimedia services. 
1. **Jobayer Morshed and Abdel Ouahd Alouane** ([Institut Polytechnique de Paris](https://www.ip-paris.fr/en), 11/2021--04/2022). Topic: Scheduling coflows in datacenter networks.
{% endcapture %}
